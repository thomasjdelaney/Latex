...
\begin{description}
  ...
  \item[14/11/2020-16/11/2020] Emailed some people. Called the bank. Added to the Moby Dick repo. Need finish the email to David Greenwood in the morning.
	...
	\item[13/12/2020 - 15/12/2020] Wrote a reference letter for Mohit Kulkarni.

	\item[16/12/2020 - 22/12/2020] Attended final meetings for IRCN. Contacted Terry Lynch. \\ Conor Keirnan got back to me. Sent him my CV and a cover letter. Read some interesting job advertisments. Got in touch with recruiter through Terry.

	\item[23/12/2020 - 26/12/2020] Stared the `Self Authoring' program. Added to the CV.
\end{description}
